...
export default {
  ...
  data() {
    ...
    return {
      ...
      lineItems: [
        {
          price: 'price_1LkrNxFS63sMTPizvhAtQ6m2', // The id of the recurring price you created in your Stripe dashboard
          quantity: 1,
        }
      ],
      successURL: 'http://127.0.0.1:8000/#/success?session_id=Basic',
